...
export const competencies = [
  {
    label: "Architecture",
    items: ["Scalable Mobile Architecture", "Clean Architecture", "SOLID Principles"],
  },
  {
...
export const skillGroups = [
  ...
  {
    label: "Workflow",
    items: ["Git", "GitHub", "GitLab", "Scrum", "Kanban", "Jira", "Trello", "ClickUp"],
  },
] as const;
...
export const languages = [
  ...
  { name: "English", level: "B2", detail: "Upper-Intermediate, spoken & written" },
] as const;
